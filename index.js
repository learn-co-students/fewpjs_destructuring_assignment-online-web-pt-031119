...
const [name,color,song,job,partner] = ['Kermit','green','The Rainbow Connection','Host of The Muppet Show','Miss Piggy'];

// 8. Use destructuring to assign songs 2 and 4, and Kermit's job and partner
const [song_2,song_4,k_job,k_partner] = ['Moving Right Along','I Hope That Something Better Comes Along','Host of The Muppet Show','Miss Piggy'];